...
export class FindMain {
        ...
        if (!filesExeption){
            ...
            try {
                targetFiles.forEach(file => {
                    ...
                    const content = this.accumulator.readFileSync(filePath, 'utf8');
                    let match;
                    let found = false;
            ...
            try {
                ...
                states.forEach(theState => {
                    if (theState.quantifyFound()===0 && options.outputFilename){
                        ...
                        this.accumulator.logFile("file:", theState.printFilename(), Emoji.EMPTYOK);
                    }
                });
                if (notFoundHeaderPrinted){
                    console.log(             "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    ...
    loadFrameworkSuppressionsForFile(sourceFilename, datadir = "data") {
        ...
        const lines = this.accumulator.readFileSync(result.planFile, 'utf8')
            .split('\n')
            .map(line => line.trim())
    ...
    readConfig(options, configFilename){
        try {
            ...
            const data = this.accumulator.readFileSync(configFilename, 'utf8');
